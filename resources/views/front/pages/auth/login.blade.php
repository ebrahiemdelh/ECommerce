        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <form class="card login-form" method="post" action="{{route('front.login')}}">
                        @csrf
                        <div class="card-body">
                            <div class="title">
                                <h3>Login Now</h3>
                                {{-- <p>You can login using your social media account or email address.</p> --}}
                                <p>You can login using  email address.</p>
                            </div>
                            ...
                            <p class="outer-link">Don't have an account? <a href="{{route('front.register')}}">Register here </a>
                            </p>
                        </div>
                    </form>
                </div>
